...
valds=augmentedImageDatastore([m n],valds,"ColorPreprocessing","gray2rgb");
...
if input("to train network for new data press 1 and enter:")==1
    ...
    figure(a)
    opts = trainingOptions(alg(y),"InitialLearnRate",0.0001,"MaxEpochs",50,"VerboseFrequency",1,'Plots','training-progress',"ValidationData",valds,"ValidationFrequency",1);
